        ...
        <div className="border-t flex p-3">
          ...
          >
            <div className="leading-4">
              ...
              <span className="text-xs text-gray-600 color-black">johndoe@gmail.com</span>
            </div>
            <MoreVertical className="text-black" size={20} />
          </div>
        </div>
      </nav>
    </aside>
...
export function SidebarItem({ icon, text, active, alert }) {
  ...
  return (
    ...
    >
      {icon}
      <span
        className={`overflow-hidden transition-all text-black font-inter ${
